...
2. **Clone and enter the project:**
   ...
   .. code-block:: bash
       ...
       git clone <repo-url>
       cd cookiecutter_aws_lbd_demo-project
...
:mod:`~cookiecutter_aws_lbd_demo.one.one_01_config`).  On Lambda,
...
You edited files in :mod:`~cookiecutter_aws_lbd_demo.lbd` or other package
...
- ``cookiecutter_aws_lbd_demo/lbd/*.py`` (or any package source code)
...
You edited :mod:`~cookiecutter_aws_lbd_demo.cdk.stacks.infra_stack` to add
...
- ``cookiecutter_aws_lbd_demo/cdk/stacks/infra_stack.py``

If you added a new ``CfnOutput``, also update
``cookiecutter_aws_lbd_demo/cdk/stacks/infra_stack_exports.py`` with a
...
.. list-table::
   ...
   * - File
     - Action
   * - ``cookiecutter_aws_lbd_demo/lbd/my_func.py``
   ...
   * - ``cookiecutter_aws_lbd_demo/config/config_00_main.py``
     - **Edit** — add ``lbd_func_my_func`` field
   * - ``cookiecutter_aws_lbd_demo/one/one_01_config.py``
...
``cd cdk && cdk destroy cookiecutter-aws-lbd-demo-lbd --profile $LOCAL_AWS_PROFILE``.
...
See :mod:`~cookiecutter_aws_lbd_demo.cdk.stacks.lambda_stack` line ~88 for
the explanation.
